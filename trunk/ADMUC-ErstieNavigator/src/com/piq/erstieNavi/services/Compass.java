...
public class Compass {
	...
	/**
	 * Params: lat1, long1 => Latitude and Longitude of current point lat2, long2 => Latitude and Longitude of target point headX => x-Value of built-in phone-compass Returns the degree of a direction
	 * from current point to target point
	 */
