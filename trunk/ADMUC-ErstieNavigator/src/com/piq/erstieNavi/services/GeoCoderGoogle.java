...
public class GeoCoderGoogle {
	public String reverseGeoCode(double latitude, double longitude) {
		...
		try {
			...
			serverAddress = new URL("http://maps.google.com/maps/geo?q=" + String.valueOf(latitude) + "," + String.valueOf(longitude) + "&output=xml&oe=utf8&sensor=true&key=" + R.string.GOOGLE_MAPS_API_KEY);
