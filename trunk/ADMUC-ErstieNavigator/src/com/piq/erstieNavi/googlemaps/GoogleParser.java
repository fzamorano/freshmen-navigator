...
public class GoogleParser extends XMLParser implements Parser {
	...
	public Route parse(GeoPoint startGeo, GeoPoint destGeo) {
		...
		try {
			...
			/*
			 * Loop through the steps, creating a segment for each one and decoding any polylines found as we go to add to the route object's map array. Using an explicit for loop because it is
			 * faster!
			 */
